...
public class AdapterLicenses extends BaseExpandableListAdapter
{
    ...
    public AdapterLicenses(Context context, List<BaseLicenseEntry> licenses)
    {
        mContext = context;
        mLicenses = licenses;
    }

    public void updateList(List<BaseLicenseEntry> licenses)
    {
        mLicenses = licenses;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        BaseLicenseEntry entry = mLicenses.get(groupPosition);
        ...
        if (entry.isLoaded())
            ...
            tvLicense.setText(R.string.ld_loading);
